...
async function applyCompatibilityPatch() {
  ...
  const statements = [
    `DO $$ BEGIN
      ...
      BEGIN ALTER TYPE "PaymentStatus" ADD VALUE IF NOT EXISTS 'CANCELLED'; EXCEPTION WHEN others THEN NULL; END;
      BEGIN ALTER TYPE "PaymentStatus" ADD VALUE IF NOT EXISTS 'REFUNDED'; EXCEPTION WHEN others THEN NULL; END;
    END $$;`,
